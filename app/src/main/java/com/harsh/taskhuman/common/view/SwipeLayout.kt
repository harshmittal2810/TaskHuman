package com.harsh.taskhuman.common.view
...
class SwipeLayout @JvmOverloads constructor(
    ...
    companion object {
        ...
        private val designerConstructors = ThreadLocal<MutableMap<String, Constructor<Designer>>>()
    }
    ...
    private fun checkCanDrag(ev: MotionEvent) {
        ...
        if (openState and FLAG_IS_OPENED == FLAG_IS_OPENED || openState and FLAG_IS_OPENING == FLAG_IS_OPENING) {
        ...
        when (ev.actionMasked) {
            ...
            MotionEvent.ACTION_MOVE -> {
                ...
                if (!beforeCheckDrag && isDragging) {
                    ...
                    val cancelEvent =
                        MotionEvent.obtain(ev).also { it.action = MotionEvent.ACTION_CANCEL }
    ...
    private fun setContentViewOffset() {
        ...
        if (activeMenu == leftMenu) {
            ...
            designer.onLayout(
                activeMenu, paddingLeft, paddingTop, contentView.left, bottom - paddingBottom
            )
        } else {
    ...
    private inner class ViewDragCallback : ViewDragHelper.Callback() {
        ...
        override fun clampViewPositionHorizontal(child: View, left: Int, dx: Int): Int {
            ...
            when (child) {
                ...
                leftMenu -> {
                    val offset = (contentView.left + dx).coerceIn(
                        paddingLeft,
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        setMeasuredDimension(
            resolveSizeAndState(childWidth, widthMeasureSpec, childState), resolveSizeAndState(
                childHeight, heightMeasureSpec, childState shl MEASURED_HEIGHT_STATE_SHIFT
            )
        )
    ...
    interface Designer {
        ...
        companion object {
            fun parseDesigner(context: Context, name: String?): Designer? {
                ...
                val fullName = if (name.startsWith(".")) context.packageName + name else name
                ...
                try {
                    ...
                    if (c == null) {
                        @Suppress("UNCHECKED_CAST") val clazz =
                            Class.forName(fullName, false, context.classLoader) as Class<Designer>
    ...
    class ParallaxDesigner : Designer {
        ...
        private fun layoutLeftMenu(menuView: ViewGroup, left: Int, right: Int) {
            ...
            for (i in 1 until menuView.childCount) {
                ...
                child.layout(
                    childRight - child.width, child.top, childRight, child.bottom
                )
                prevChild = child
            }
        }
        ...
        private fun layoutRightMenu(menuView: ViewGroup, left: Int, right: Int) {
            ...
            for (i in menuView.childCount - 2 downTo 0) {
                ...
                child.layout(
                    childLeft, child.top, childLeft + child.width, child.bottom
                )
                prevChild = child
            }
        }
